...
namespace App\Models\Lms\fillQuestion\Traits\Attribute;


trait fillQuestionAttribute
{
    ...
    {
        return '<a href="'.route('lms.fillQuestion.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.fillQuestion.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.fillQuestion.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.fillQuestion.restore', $this).'" 
        name="restore_fillQuestion" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.fillQuestion.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.fillQuestion.delete-permanently', $this).'" name="delete_fillQuestion_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.fillQuestion.delete_permanently').'"></i></a> ';
    }

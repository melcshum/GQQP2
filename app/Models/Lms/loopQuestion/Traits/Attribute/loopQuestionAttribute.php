...
namespace App\Models\Lms\loopQuestion\Traits\Attribute;


trait loopQuestionAttribute
{
    ...
    {
        return '<a href="'.route('lms.loopQuestion.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.loopQuestion.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.loopQuestion.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.loopQuestion.restore', $this).'" 
        name="restore_loopQuestion" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.loopQuestion.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.loopQuestion.delete-permanently', $this).'" name="delete_loopQuestion_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.loopQuestion.delete_permanently').'"></i></a> ';
    }

...
namespace App\Models\Lms\arrayQuestion\Traits\Attribute;


trait arrayQuestionAttribute
{
    ...
    {
        return '<a href="'.route('lms.arrayQuestion.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.arrayQuestion.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.arrayQuestion.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.arrayQuestion.restore', $this).'" 
        name="restore_arrayQuestion" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.arrayQuestion.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.arrayQuestion.delete-permanently', $this).'" name="delete_arrayQuestion_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.arrayQuestion.delete_permanently').'"></i></a> ';
    }

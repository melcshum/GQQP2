...
namespace App\Models\Lms\Question\Traits\Attribute;
...
trait QuestionAttribute
{
    ...
    {
        return '<a href="'.route('lms.question.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.question.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.question.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.question.restore', $this).'" 
        name="restore_question" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.question.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.question.delete-permanently', $this).'" name="delete_question_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.question.delete_permanently').'"></i></a> ';
    }

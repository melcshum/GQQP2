...
namespace App\Models\Lms\Model\Traits\Attribute;
...
trait ModelAttribute
{
    ...
    {
        return '<a href="'.route('lms.model.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.model.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.model.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.model.restore', $this).'" 
        name="restore_model" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.model.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.model.delete-permanently', $this).'" name="delete_model_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.model.delete_permanently').'"></i></a> ';
    }

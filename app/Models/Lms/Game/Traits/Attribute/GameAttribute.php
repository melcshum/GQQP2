...
namespace App\Models\Lms\Game\Traits\Attribute;
...
trait GameAttribute
{
    ...
    {
        return '<a href="'.route('lms.game.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        //  if ($this->id != access()->id()) {
            switch ($this->status) {
                case 0:
                    return '<a href="'.route('lms.game.mark', [
                        $this,
                        1,
                    ]).'" class="btn btn-xs btn-success"><i class="fa fa-play" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.games.activate').'"></i></a> ';
                // No break
                ...
                case 1:
                    return '<a href="'.route('lms.game.mark', [
                        $this,
                        0,
                    ]).'" class="btn btn-xs btn-warning"><i class="fa fa-pause" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.games.deactivate').'"></i></a> ';
                // No break
    ...
    { 
        return '<a href="'.route('lms.game.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.game.restore', $this).'" 
        name="restore_game" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.game.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.game.delete-permanently', $this).'" name="delete_game_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.game.delete_permanently').'"></i></a> ';
    }

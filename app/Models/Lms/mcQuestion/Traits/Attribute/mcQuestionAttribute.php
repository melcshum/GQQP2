...
namespace App\Models\Lms\mcQuestion\Traits\Attribute;


trait mcQuestionAttribute
{
    ...
    {
        return '<a href="'.route('lms.mcQuestion.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        switch ($this->status) {
            case 0:
                return '<a href="'.route('lms.mcQuestion.mark', [
                    $this,
                    1,
    ...
    {
        return '<a href="'.route('lms.mcQuestion.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.mcQuestion.restore', $this).'" 
        name="restore_mcQuestion" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.mcQuestion.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.mcQuestion.delete-permanently', $this).'" name="delete_mcQuestion_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.mcQuestion.delete_permanently').'"></i></a> ';
    }

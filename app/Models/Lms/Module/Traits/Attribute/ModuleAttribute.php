...
namespace App\Models\Lms\Module\Traits\Attribute;
...
trait ModuleAttribute
{
    ...
    {
        return '<a href="'.route('lms.module.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
    ...
    public function getStatusButtonAttribute()
    {
        ...
        //  if ($this->id != access()->id()) {
            switch ($this->status) {
                case 0:
                    return '<a href="'.route('lms.module.mark', [
                        $this,
                        1,
                    ]).'" class="btn btn-xs btn-success"><i class="fa fa-play" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.modules.activate').'"></i></a> ';
                // No break
                ...
                case 1:
                    return '<a href="'.route('lms.module.mark', [
                        $this,
                        0,
                    ]).'" class="btn btn-xs btn-warning"><i class="fa fa-pause" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.modules.deactivate').'"></i></a> ';
                // No break
    ...
    { 
        return '<a href="'.route('lms.module.destroy', $this).'"
             data-method="delete"
    ...
    {
        return '<a href="'.route('lms.module.restore', $this).'" 
        name="restore_module" class="btn btn-xs btn-info">
        <i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.module.restore_user').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('lms.module.delete-permanently', $this).'" name="delete_module_perm" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.lms.module.delete_permanently').'"></i></a> ';
    }

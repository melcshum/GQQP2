...
@section ('title', trans('labels.lms.modules.management'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.modules.active') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.modules.active') }}</h3>

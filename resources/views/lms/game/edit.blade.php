...
@section ('title',  trans('labels.lms.games.management') . ' | ' . trans('labels.lms.games.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.games.management') }}
        <small>{{ trans('labels.lms.games.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($game, ['route' => ['lms.game.update', $game], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.games.edit') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        {{ Form::checkbox('status', '1', $game->status) }}
                    </div><!--col-lg-1-->
                </div><!--form control-->

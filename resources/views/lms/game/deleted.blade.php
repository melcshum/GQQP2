...
@section ('title',  trans('labels.lms.games.management') . ' | ' . trans('labels.lms.games.deleted'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.games.deleted') }} </small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.games.deleted') }}</h3>
...
//                    {data: 'updated_at', name: '{{config('access.users_table')}}.updated_at'},
            ...
            $("body").on("click", "a[name='delete_game_perm']", function(e) {
                ...
                swal({
                    ...
                    text: "{{ trans('strings.lms.games.delete_game_confirm') }}",
                    type: "warning",
            ...
            $("body").on("click", "a[name='restore_game']", function(e) {
                ...
                swal({
                    title: "{{ trans('strings.backend.general.are_you_sure') }}",
                    text: "{{ trans('strings.lms.games.restore_game_confirm') }}",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "{{ trans('strings.backend.general.continue') }}",

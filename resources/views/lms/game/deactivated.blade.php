...
@section ('title',  trans('labels.lms.games.management') . ' | ' . trans('labels.lms.games.deactivated'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.games.deactivated') }} </small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.games.deactivated') }}</h3>

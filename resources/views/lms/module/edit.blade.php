...
@section ('title',  trans('labels.lms.modules.management') . ' | ' . trans('labels.lms.modules.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.modules.management') }}
        <small>{{ trans('labels.lms.modules.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($module, ['route' => ['lms.module.update', $module], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.modules.edit') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1"> 
                        {{ Form::checkbox('status', '1', $module->status) }}
                    </div><!--col-lg-1-->
                </div><!--form control-->

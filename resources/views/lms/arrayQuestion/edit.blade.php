...
@section ('title',  trans('labels.lms.arrayQuestions.management') . ' | ' . trans('labels.lms.arrayQuestions.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.arrayQuestions.management') }}
        <small>{{ trans('labels.lms.arrayQuestions.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($arrayQuestion, ['route' => ['lms.arrayQuestion.update', $arrayQuestion], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'files' => true]) }}


        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.arrayQuestions.edit') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('hint', trans('validation.attributes.lms.arrayQuestions.hint'), ['class' => 'col-lg-2 control-label']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1"> 
                        {{ Form::checkbox('status', '1', $arrayQuestion->status) }}
                    </div><!--col-lg-1-->
                </div><!--form control-->

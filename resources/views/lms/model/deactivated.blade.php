...
@section ('title',  trans('labels.lms.models.management') . ' | ' . trans('labels.lms.models.deactivated'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.models.deactivated') }} </small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.models.deactivated') }}</h3>

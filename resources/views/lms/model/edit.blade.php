...
@section ('title',  trans('labels.lms.models.management') . ' | ' . trans('labels.lms.models.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.models.management') }}
        <small>{{ trans('labels.lms.models.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($model, ['route' => ['lms.model.update', $model], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.models.edit') }}</h3>

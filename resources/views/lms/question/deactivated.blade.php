...
@section ('title',  trans('labels.lms.questions.management') . ' | ' . trans('labels.lms.questions.deactivated'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.questions.deactivated') }} </small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.questions.deactivated') }}</h3>

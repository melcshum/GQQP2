...
@section ('title',  trans('labels.lms.questions.management') . ' | ' . trans('labels.lms.questions.create'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.questions.management') }}
        <small>{{ trans('labels.lms.questions.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'lms.question.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.questions.create') }}</h3>

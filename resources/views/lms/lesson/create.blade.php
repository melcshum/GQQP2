...
@section ('title',  trans('labels.lms.lessons.management') . ' | ' . trans('labels.lms.lessons.create'))

@section('page-header')
    <h1>
        {{ trans('labels.lms.lessons.management') }}
        <small>{{ trans('labels.lms.lessons.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'lms.lesson.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.lms.lesson.create') }}</h3>

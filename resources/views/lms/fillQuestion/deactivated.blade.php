...
@section ('title',  trans('labels.lms.fillQuestions.management') . ' | ' . trans('labels.lms.fillQuestions.deactivated'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.fillQuestions.deactivated') }} </small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.fillQuestions.deactivated') }}</h3>

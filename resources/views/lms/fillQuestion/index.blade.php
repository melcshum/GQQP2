...
@section ('title', trans('labels.lms.fillQuestions.management'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.lms.fillQuestions.active') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.lms.fillQuestions.active') }}</h3>
                ...
                <table id="fillQuestions-table" class="table table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.lms.fillQuestions.table.question') }}</th>
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            {!! history()->renderType('fillQuestion') !!}
        </div><!-- /.box-body -->
    </div><!--box box-success-->
@stop
        ...
        $(function() {
            $('#fillQuestions-table').DataTable({
                ...
                columns: [
                     ...
                     {data: 'question', name: '{{config('lms.fillQuestions_table')}}.question', render: $.fn.dataTable.render.text()},
